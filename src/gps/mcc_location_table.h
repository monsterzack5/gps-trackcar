 ...
 */
inline __attribute__((always_inline)) int32_t lat_convert(float lat)
{
    const float lat_conv = (8388608.0f / 90.0f);
 ...
 */
inline __attribute__((always_inline)) int32_t lon_convert(float lon)
{
    const float lon_conv = (16777216.0f / 360.0f);
